...
chain = RunnablePassthrough.assign(chat_history=load_memory) | prompt_template | chat #| HTMLOutputParser()
...
# response = chain.invoke("환영해, 당황아! 난 기쁨이야!")
# print(response)
# response = chain.invoke("주먹 인사... 아니, 어... 그냥 하이파이브 하자. 손에 땀이 엄청 많구나.")
# print(response)
# response = chain.invoke("내 이름이 뭐라고?")
# print(response)